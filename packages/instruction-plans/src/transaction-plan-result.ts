 ...
 */
export type SequentialTransactionPlanResult<TContext extends object = object> = Readonly<{
    divisible: boolean;
    kind: 'sequential';
 ...
 * @see {@link parallelTransactionPlanResult}
 */
export type ParallelTransactionPlanResult<TContext extends object = object> = Readonly<{
    kind: 'parallel';
    plans: TransactionPlanResult<TContext>[];
}>;
...
export type SingleTransactionPlanResult<
    ...
    TTransactionMessage extends CompilableTransactionMessage = CompilableTransactionMessage,
> = Readonly<{
    kind: 'single';
 ...
 * @see {@link SequentialTransactionPlanResult}
 */
export function sequentialTransactionPlanResult<TContext extends object = object>(
    plans: TransactionPlanResult<TContext>[],
): SequentialTransactionPlanResult<TContext> & { divisible: true } {
 ...
 * @see {@link SequentialTransactionPlanResult}
 */
export function nonDivisibleSequentialTransactionPlanResult<TContext extends object = object>(
    plans: TransactionPlanResult<TContext>[],
): SequentialTransactionPlanResult<TContext> & { divisible: false } {
 ...
 * @see {@link ParallelTransactionPlanResult}
 */
export function parallelTransactionPlanResult<TContext extends object = object>(
    plans: TransactionPlanResult<TContext>[],
): ParallelTransactionPlanResult<TContext> {
