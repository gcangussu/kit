 ...
 * - {@link MessagePackerInstructionPlan} - A plan that can be iterated over to retrieve
 ...
 * This is useful to assess whether the message packer plan can be fully included
 ...
 */
export type MessagePackerInstructionPlan<TInstruction extends Instruction = Instruction> = Readonly<{
...
/**
 * The iterator returned by the {@link MessagePackerInstructionPlan}.
 *
...
/**
 * Creates an {@link MessagePackerInstructionPlan} that generates a list of instructions
...
/**
 * Creates a simple {@link MessagePackerInstructionPlan} from a list of instructions.
 *
...
): MessagePackerInstructionPlan<TInstruction> {
    return Object.freeze({
        getAll: () => instructions,
        getIterator: () => {
...
/**
 * Creates an {@link MessagePackerInstructionPlan} that generates a list of realloc instructions.
 *
